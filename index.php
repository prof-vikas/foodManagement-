    ...
    <?php 
        if(isset($_SESSION['order']))
        {
            ...
            echo $_SESSION['order'];
            echo "<script>swal('Yummy mmm!', 'Ordered Placed Successfully','success');</script>";
            unset($_SESSION['order']);
        }
    ?>

    <!-- CAtegories Section Starts Here -->
    <section class="categories" style="background-color:#E2F6E8">
        <div class="container">
                    ...
                    while($row=mysqli_fetch_assoc($res))
                    {
                        ...
                        <a href="<?php echo SITEURL; ?>category-foods.php?category_id=<?php echo $id; ?>">
                            <div class="box-3 float-container">
                                ...
                                <h3 class="float-text text-white" ><mark style="background-color:#E2F6E8;"><?php echo $title; ?></mark></h3>
                            </div>
                        </a>
    ...
    <section class="food-menu" style="background-color:#dedede">
        <div class="container">
